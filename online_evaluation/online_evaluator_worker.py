    ...
    def distribute_evaluate(
        ...
        while True:
            ...
            to_log = dict(
                ...
                cost_robot_path=sample_result["cost_robot_path"],
                cost_object_path=sample_result["cost_object_path"],
            )
            if verbose:
                print(to_log)
            ...
            if send_videos_back and task_info["needs_video"]:
                eps_name = (
                    str(sample_result["metrics"]["cost_robot"]) + "_" + str(sample_result["metrics"]["cost_object"]) + "_" + task_info["sample_id"] + "_" + sample_result["goal"].replace(" ", "-") + ".mp4"
                )
                ...
                video_table_data = dict(
                    ...
                    sum_cost_robot=sample_result["metrics"]["cost_robot"],
                    sum_cost_object=sample_result["metrics"]["cost_object"],
